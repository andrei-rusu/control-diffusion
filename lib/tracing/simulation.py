...
from lib.tracing.utils import Event
from lib.tracing.exp_sampler import get_sampler
...
class Simulation():
    ...
    def get_next_event(self):
        ...
        for nid in node_list:
            ...
            # The following commented out block can be used to verify the dynamically-updated neighbor counts of susceptibles against the true counts
            # This execution is rather slow, hence the commenting out. If more than 5 violations are found, this block of code will raise a ValueError!
            # if current_state == 'S':
