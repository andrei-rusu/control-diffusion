...
class Network(nx.Graph):
    ...
    def init_random(self, n=200, k=10, typ='random', p=.1, weighted=False, seed=None, edge_sample_size=None):
    ...
    def draw(self, pos=None, show=True, ax=None, layout_type='spring_layout', seed=43, legend=True, full_name=False, model='covid', node_size=300, degree_size=False, dual_inf_uninf=True):
        ...
        # draw graph
        nx.draw(self, pos=pos, node_color=colors, ax=ax, with_labels=True, labels=self.node_names, node_size=node_size)
...
def get_from_predef(nx_or_edgelist, rem_orphans=False, count_importance=1, inet=0, use_weights=False, W_factor=0, K_factor=10, reindex=False, **kwargs):
    """
