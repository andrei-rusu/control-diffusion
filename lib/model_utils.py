...
class NoValidPB(pl.callbacks.ProgressBar):
    """
    Overrides tqdm bar during validation, thus disabling it
    """
...
class AddTrainValTestMask(object):
    r"""DEPRECATED in favor of torch_geometric.transforms.AddTrainValTestMask
    Adds a node-level random split via :obj:`train_mask`, :obj:`val_mask`
